...
public class DelegateAccessor2Tests
{
    private static readonly Func<TodoItem, object?> _getter = todo => todo.Id;
    private static readonly Action<TodoItem, object?> _setter = (todo, value) => todo.Id = (long)value!;
    private static readonly DelegateAccessor<TodoItem> _accessor = new(typeof(long), _getter, _setter);
